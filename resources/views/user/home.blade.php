  ...
  <div class="page-hero bg-image overlay-dark" style="background-image: url(../assets/img/bg_image_1.jpg);">
    <div class="hero-section">
      <div class="container text-center wow zoomIn">
        <span class="subhead">LA SALUD DE LAS MASCOTAS IMPORTA</span>
        <h1 class="display-4">Vida Saludable</h1>
        <a href="#" class="btn btn-primary">Consultémoslo</a>
      </div>
    </div>
  </div>
        ...
        <div class="row justify-content-center">
          <div class="col-md-4 py-3 py-md-0">
            <div class="card-service wow fadeInUp">
              ...
              <p><span>Chatea</span> con un veterinario</p>
            </div>
          </div>
          <div class="col-md-4 py-3 py-md-0">
            <div class="card-service wow fadeInUp">
              ...
              <p><span>Pro</span>teccion de la salud única</p>
            </div>
          </div>
          <div class="col-md-4 py-3 py-md-0">
            <div class="card-service wow fadeInUp">
